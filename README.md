...
class Nithin:
    ...
    ml_stack     = ["TensorFlow", "scikit-learn", "CUDA", "NumPy", "Pandas"]
    platforms    = ["TryHackMe", "HackTheBox"]
    motto        = "Break things ethically. Fix them permanently."

    def threat_level(self) -> str:
        return "[!] ELEVATED — Always learning. Always scanning."
...
4444/tcp    open    ml-training      Model Pipelines | Data Engineering
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=000000&height=120&section=footer&text=root%40nithin%3A~%23%20_&fontColor=ffffff&fontSize=26&fontAlignY=70&animation=twinkling&fontAlign=50" />
